          ...
          <div className="max-w-2xl mx-auto mb-8">
            <div className="p-6 bg-background/80 backdrop-blur-sm rounded-xl border-2 border-primary/20">
              ...
              <p className="text-base text-muted-foreground leading-relaxed mb-4">
                See why our 5-Day, $1,299 Sprint delivers more value than any other program. Join our free webinar to meet the industry leaders and ask your questions directly.
              </p>
              <Button
                size="lg"
              ...
              >
                Meet Our Mentors — Join Free Webinar
              </Button>
            </div>
          </div>
        </div>
